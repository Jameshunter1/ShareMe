...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>{fields && (
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
          ...
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  <div className='flex flex-col justify-center items-center'>
                    <p className='font-bold text-2xl'>  <AiOutlineCloudUpload />
                    </p>
              ...
              <div className='relative h-full'>
                <img src={imageAsset?.url} className="h-full w-full" alt="uploaded" />
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          ...
          <input type="text" onChange={(e) => setDestination(e.target.value)} placeholder="Add a destination link." className='outline-none text-base sm:text-lg border-b-2 border-gray-200 p-2' />
            ...
            <div>
              ...
              >
                ...
                {categories.map((category) => (
                  <option className='text-base border-0 outline-none capiitlize'>{category.name}</option>
                ))}
